...
// Updated to 0.012F from 0.001F to handle +/- 16 g
...
bool Adafruit_LSM303_Accel_Unified::begin()
{
  ...
  uint8_t reg4 = read8(LSM303_ADDRESS_ACCEL, LSM303_REGISTER_ACCEL_CTRL_REG4_A);

  reg4 = reg4 | 0x30;
  
  write8(LSM303_ADDRESS_ACCEL, LSM303_REGISTER_ACCEL_CTRL_REG4_A, reg4); // Modifications to handle +/- 16 g
